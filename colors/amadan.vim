...
"         Name: amadan.vim
"
" Based on "fu.vim" by Aaron Mueller <mail@aaron-mueller.de>
...
hi String         ctermfg=107   ctermbg=233                  guifg=#87af5f  guibg=#121212  gui=italic
hi Character      ctermfg=228   ctermbg=16                   guifg=#ffff87  guibg=#000000  gui=italic
...
hi Statement      ctermfg=103                                guifg=#8787af                 gui=bold
hi Conditional    ctermfg=105                                guifg=#8787ff                 gui=bold
hi Repeat         ctermfg=105                                guifg=#8787ff                 gui=bold
hi Label          ctermfg=105                                guifg=#8787ff                 gui=bold
hi Operator       ctermfg=243                                guifg=#767676                 gui=bold
hi Keyword        ctermfg=190                                guifg=#d7ff00                 gui=bold
hi Exception      ctermfg=166   ctermbg=0                    guifg=#d75f00  guibg=#000000  gui=bold

hi PreProc 		    ctermfg=229                                guifg=#ffffaf
hi Include        ctermfg=229                                guifg=#ffffaf                 gui=bold,italic
hi Define         ctermfg=229                                guifg=#ffffaf                 gui=bold,italic
hi Macro          ctermfg=229                                guifg=#ffffaf                 gui=bold,italic
hi PreCondit      ctermfg=229                                guifg=#ffffaf                 gui=bold,italic

hi Type           ctermfg=111                                guifg=#87afff                 gui=bold
hi Structure      ctermfg=111   ctermbg=233                  guifg=#87afff  guibg=#121212  gui=bold
...
hi rubyClass                 ctermfg=75                      guifg=#5fafff                 gui=bold
hi rubyDefine                ctermfg=75                      guifg=#5fafff                 gui=bold
hi rubyModule                ctermfg=75                      guifg=#5fafff                 gui=bold
